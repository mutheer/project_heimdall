/*
  # RLS Policy Optimization and Consolidation

  1. Performance Optimizations
    - Fix auth_rls_initplan warnings by using subquery patterns
    - Optimize is_admin() function with STABLE marking
    - Update log_admin_action() function for better performance

  2. Policy Consolidation
    - Remove duplicate policies causing multiple_permissive_policies warnings
    - Consolidate similar policies into single, efficient policies
    - Maintain all security requirements while improving performance

  3. Security
    - Preserve all existing access controls
...
-- Create optimized policies for alerts
...
-- Create separate policies for analysts to manage threats
