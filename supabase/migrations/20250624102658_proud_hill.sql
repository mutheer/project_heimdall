/*
  # RLS Policy Optimization and Performance Improvements

  1. Security Enhancements
    - Optimized is_admin() function with subquery pattern
    - Consolidated duplicate policies across all tables
    - Enhanced audit logging with performance improvements

  2. Performance Improvements
    - Added performance indexes for auth patterns
    - Optimized RLS policies to reduce function calls
    - Streamlined policy structure for better query planning

  3. Tables Updated
    - external_systems: Admin access and read policies
    - admin_audit_logs: Admin view and insert policies
    - users: Profile update policy optimization
    - alerts: Admin access and user view policies
    - reports: Admin access, view, and create policies
    - system_logs: Admin access and view policies
    - system_settings: Admin access policy
    - threats: Admin access, view, and management policies

  4. Security Verification
    - RLS enabled on all required tables
    - All access controls preserved
    - Admin audit logging maintained
*/
